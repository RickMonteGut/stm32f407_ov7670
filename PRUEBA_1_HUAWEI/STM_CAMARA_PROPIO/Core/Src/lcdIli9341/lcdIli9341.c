// codigo de LCD funcional ili9341
...
//____________________________________________________________________________AÑADIDO DE IWITAKE
...
#define FSMC_NIx			  0               // cambio a cero por el tipo de memoria, a 16 bits la información se desplaza un lugar, a 8 bits creo que se desplaza 0 unidades
#define FSMC_Bx				  18			  // porque es el pin 18 el RS
#define FSMC_Cx 			  8               //porque es de 8 bits


//_______________DE LCD.C

#define FSMC_ADDRESS  (0x60000000 + ((FSMC_NEx-1) << 26))      //aqui cambio NEx por NIx y viceversa
#define LCD_CMD_ADDR  (FSMC_ADDRESS)


#define LCD_DATA_ADDR (FSMC_ADDRESS | 1 << (FSMC_Bx + 0))         //aqui cambio Ax por Cx o Bx, depende de la prueba  ; además cambio FSMC_ADDRESS por
#define LCD_CMD       (*((volatile uint8_t*) LCD_CMD_ADDR))       //cambio LCD_CMD_ADDR por 0x60000000
...
//_____________________________________________________________________________FIN DE IWITAKE
