...
#define OV7670_QVGA_WIDTH  320     // cambie el valor de 320 por 80
#define OV7670_QVGA_HEIGHT  240    // cambie el valor de 240 a 130
...
static uint32_t    s_destAddressForContiuousMode;      // aqui cambié de 32 a 16
